...
include('includesp/categoryClass.php');
 $c= new Category();
?>
<!-- Main Menu Section -->
...
<div class="hero-slider">
  ...
  <div class="slider-item th-fullpage hero-area" style="background-image: url(images/slider/2.png);">
    <div class="container">
      <div class="row">
        ...
        foreach ($data as $key => $value) {
			...
			<div class='col-md-6'>
				<div class='category-box'>
					<a href='product.php?cat_id={$row['cat_id']}'>
						<img src='Admin/img/cat/{$row['cat_image']}' alt=''  width='300' height='150'/>
						<div class='content'>
							<h1>{$row['cat_name']}</h1>
						</div>
					</a>	
